...
def get_dominant_freq(real_freq_domain_part, imag_freq_domain_part):
    ...
    if (max_real > max_imag):
        ...
        dominant_freq = abs(
            fftfreq(len(imag_freq_domain_part), d=(1.0 / 44100.0))[imag_freq_domain_part.index(max_imag)])
...
class VAD(object):
    ...
    def moattar_homayounpour(wave_file, average_intensity, instances):
        ...
        average_intensity = ((old_average_intensity * (instances - 1)) + intensity) / float(
